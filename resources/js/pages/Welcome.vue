    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">Welcome to Our Store</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Discover amazing products and start shopping today. <br />Here's what you can do:
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                <strong>Browse Products</strong> - Explore our wide selection of items
                            </span>
                        </li>
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            ...
                            <span>
                                <strong>Add to Cart</strong> - Build your shopping cart with your favorite items
                            </span>
                        </li>
                        <li
                        ...
                        >
                            ...
                            <span>
                                <strong>Checkout</strong> - Complete your purchase securely and track your orders
                            </span>
                        </li>
                    </ul>
